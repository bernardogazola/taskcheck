-- MySQL Script adapted for TaskCheck
...
CREATE TABLE IF NOT EXISTS `taskcheck`.`feedback_historico` (
  ...
  -- REMOVER PARA ARRUMAR CONFLITO
  -- CONSTRAINT `feedback_historico_ibfk_1`
  -- FOREIGN KEY (`id_feedback`)
  -- REFERENCES `taskcheck`.`feedback` (`id`),
